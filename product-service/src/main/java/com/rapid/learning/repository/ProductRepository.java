...
public class ProductRepository {
    ...
    public void loadProducts(){
        ...
        redisTemplate.opsForHash().put("test", "product", allProducts);
    }

    public List<Product> getAllProducts(){
        List<Product> products = (List<Product>)redisTemplate.opsForHash().get("test", "product");
        return products;
    }


    public List<Product> getProductsByCategory(final ProductCategory category){
        return ((List<Product>)redisTemplate.opsForHash().get("test", "product")).stream()
